...
//         require(
//             msg.sender == owner,
//             "Method available only to the to the user that deployed the contract"
//         );
//         _;
//     }
...
//     event Donation(address indexed _donor, uint256 _value);
...
//     function deposit(address payable destinationAddress, uint256 charityIndex)
//         public
//         payable
